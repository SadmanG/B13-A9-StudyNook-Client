...
export function EditModal({ room }) {
    ...
    return (
        <Modal>
            <Button
                className="bg-amber-600 hover:bg-amber-700 text-white font-bold text-lg px-8 py-6 rounded-xl shadow-lg shadow-teal-950/20 active:scale-98 transition-all mr-4"
            >
